...
RAW_METADATA_DIR = f"{ROOT}/data/raw/deam_dataset/metadata/metadata"
PROCESSED_ANNOTATIONS_DIR = f"{ROOT}/data/processed/annotations"
PROCESSED_AUDIO_DIR = f"{ROOT}/data/processed/audio"
